...
Background: 
    ...
    And a project with ID 24001 exists
    
Scenario: a project leader is assigned succesfully
    When the user assigns an employee with intials "huba" as project leader for the project with ID 24001
...
Scenario: a project leader assigns a project leader when one is already assigned
    ...
    When the user assigns an employee with intials "bahu" as project leader for the project with ID 24001
